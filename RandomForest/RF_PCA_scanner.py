...
if __name__ == '__main__':
    ...
    if not os.path.exists(script_directory+f'/{n_seeds} Random Seeds PCA'):
        os.makedirs(script_directory+f'/{n_seeds} Random Seeds PCA')
    ...
    for i,k in enumerate(k_range):
        ...
        fig2.savefig(script_directory+f'/{n_seeds} Random Seeds PCA/{k}_folds.png', dpi=120)
    ...
    fig.savefig(script_directory+f'/{n_seeds} Random Seeds PCA/heatmaps.png', dpi=120)
